...
/**
 * InputUtilities to ask user for input BSc Sept 2024
 *
 * @author kheal
 */
public class InputUtils {
    ...
    /**
     * Prompts user to enter some text. if not text will keep repeating prompt
     *
    ...
    /**
     * Ask user to enter integer value if not an integer, ask again until input
     * is valid
     *
     * @param prompt the question or prompt to the user
    ...
    /**
     * Ask user to enter a integer with a given maximum if input is non-numeric
     * OR if it is too big then repeat prompt
     *
     * @param prompt the question or prompt to the user
    ...
    public int askUserForInt(String prompt, int minValue, int maxValue) {
        ...
        do {
            System.out.println(prompt);
            System.out.println("You must enter integer values between " + minValue + " and " + maxValue + " only!");
